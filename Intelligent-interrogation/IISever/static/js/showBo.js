      ...
      if(cfg.wait){  
        ...
        if(cfg.msg){
          ...
          for(i=0;i<list_length;i++){
            if(medicine_list[i]!=','&&medicine_index==0){
              medicine+=medicine_list[i];
            }
            else if(medicine_list[i]==','){
              medicine_index=1;
            }
            else if(medicine_list[i]!=';'&&medicine_index==1){
              medicine_url+=medicine_list[i];
            }
            else{
              medicine_index=0;
              this.dvCT.innerHTML+='<div class="medicine_strand">'+'<a class="medicine_a" target="_blank" href="'+medicine_url+'">'+medicine+'</a>'+'<button class="feedback_a" onclick="feedback_alert()" ></button>'+'</div>';  
              medicine='';
              medicine_url='';
            }
          }
